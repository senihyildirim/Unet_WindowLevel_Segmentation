...
docker volume create bondbidhie2024_algorithm_senih-output-$VOLUME_SUFFIX
...
docker run --rm \
        ...
        -v bondbidhie2024_algorithm_senih-output-$VOLUME_SUFFIX:/output/ \
        bondbidhie2024_algorithm_senih
...
docker volume rm bondbidhie2024_algorithm_senih-output-$VOLUME_SUFFIX